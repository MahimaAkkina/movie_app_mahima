...
const MyComponent = () => {
  ...
  const options = {
    ...
    headers: {
      'X-RapidAPI-Key': 'f6f58a22c9msh66f1b0c91c063e2p1de515jsn54c93c963933',
        ...
        <div className="w-100 d-flex align-items-center align-items-between flex-wrap">
            ...
            >
              ...
              <input
                ...
                style={{
                  color: 'hsl(80, 100%, 50%)',
                  width: '250px',
                  border: '2px solid hsl(72,100%,50%)'
                }}
              />
            </div>
            <div
          ...
          <div className="search-bar mx-3 mt-3">
            <input
              ...
              style={{ borderRadius: "5px", border: "0.3px solid grey" ,border:"2px solid hsl(80,100%,50%)"}}
            />
          </div>
        </div>
